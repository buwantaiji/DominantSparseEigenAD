...
if __name__ == "__main__":
    ...
    print("The 2-norm of the difference of v_mins corresponding to smallest eigenvalue lambda_min using two method: ", 
            np.linalg.norm(eigvectorsQ[:, 0] - eigvectors[:, 0]),
            np.linalg.norm(eigvectorsQ[:, 0] + eigvectors[:, 0]))
    print("The 2-norm of the difference of v_maxs corresponding to largest eigenvalue lambda_max using two method: ", 
